...
import UserCard from './components/connectionUserCard';
import { FetchProfile, GetAllFriends } from './action';
...
export default function Connections() {
    ...
    const [frineds, setFriends] = useState<UserInputWithId[]>([]);
    ...
    const filteredUsers = frineds.filter((user) =>
